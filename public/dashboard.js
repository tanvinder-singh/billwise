      ...
      partyList.forEach(function (p) {
        ...
        html += '<div class="party-card" data-name="' + esc(p.name).toLowerCase() + '">' +
          '<div class="card-actions">' +
            '<button type="button" class="del" title="Delete" data-id="' + p._id + '"><svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M3 6h18M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2"/></svg></button>' +
          '</div>' +
    ...
    api('GET', '/api/products?q=').then(function (data) {
      ...
      itemList.forEach(function (item) {
        html += '<div class="item-card" data-name="' + esc(item.name).toLowerCase() + '">' +
          '<div class="card-actions">' +
            '<button type="button" class="del" title="Delete" data-id="' + item._id + '"><svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M3 6h18M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2"/></svg></button>' +
          '</div>' +
